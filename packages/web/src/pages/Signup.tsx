  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="card w-full max-w-md p-8">
        ...
        <p className="text-dark-300 text-center mb-8">Start booking calls with creators</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm text-dark-200 mb-2">Phone (for join link)</label>
            <input
              type="tel"
              value={phone}
